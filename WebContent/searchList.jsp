			...
			<dd>
				<ul>
					...
					<li>	
					    <ul class="items">
					        <li class="priceItem">
					          <input class="priceInput" name="lowPrice" placeholder="¥" type="text" value=""/>
					        </li>
					        <li class="sep">-</li>
					        <li class="priceItem">
					          <input class="priceInput" name="highPrice" placeholder="¥" type="text" value=""/>
					        </li>
					    </ul> 
					</li>
				</ul>
...
<div id="houseArea">
	...
	<s:iterator value="houses" var="house" status="status">
		...
		<s:else><tr></s:else>
			<td class="house-thumb"><span><a href=""><img src="images/thumb_house.gif" /></a></span></td>
			<td>
				<dl>
					<!--要求id=房屋的id-->
